...
import { ProjectAvatar } from "@diveeoi/ui/v2/project-avatar-v2"
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_DIVEEOI_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_DIVEEOI_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
