...
beforeAll(async () => {
  ...
  mock.module("@diveeoi/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@diveeoi/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@diveeoi/ui/icon", () => ({ Icon: () => null }))
  mock.module("@diveeoi/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
