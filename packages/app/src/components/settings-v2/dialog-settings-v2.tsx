...
import { Dialog } from "@diveeoi/ui/v2/dialog-v2"
import { TabsV2 } from "@diveeoi/ui/v2/tabs-v2"
...
import { SettingsFeaturesV2 } from "./features"
  ...
  return (
    <Dialog size="x-large" variant="settings" class="settings-v2-dialog">
      <TabsV2 orientation="vertical" variant="settings" defaultValue="general" class="settings-v2">
        ...
        <TabsV2.Content value="features" class="settings-v2-panel">
          <SettingsFeaturesV2 />
        </TabsV2.Content>
