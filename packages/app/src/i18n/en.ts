export const dict = {
  ...
  "command.category.memory": "Memory",
  "command.memory.extract": "Extract memories",
  "command.memory.extract.description": "Extract memories from the current session using AI",
  "command.memory.extractAll": "Extract memories from all sessions",
  "command.memory.extractAll.description": "Extract memories from all recent sessions using AI",
  "command.memory.extractStatus": "Memory extraction status",
  "command.memory.extractStatus.description": "Show when the next automatic memory extraction will run",

  "toast.memory.extract.started": "Memory extraction started for current session",
  "toast.memory.extract.failed": "Memory extraction failed",
  "toast.memory.extractAll.started": "Memory extraction started for all sessions",
  "toast.memory.extractAll.failed": "Memory extraction for all sessions failed",
  ...
  "settings.features.notice": "Saving these settings automatically restarts the server to apply them.",
  "settings.features.section.features": "Features",
  "settings.features.section.lsp": "Language servers",
  "settings.features.lsp.master": "All language servers",
  "settings.features.lsp.masterDescription":
    "Language servers give the agent diagnostics and code intelligence. Turn off to disable them all.",
  "settings.features.envDisabled": "Disabled by the DIVEEOI_DISABLE_FEATURES environment variable.",
  "settings.features.restarting": "Restarting server…",
  "settings.features.loadFailed": "Could not load feature settings.",
  "settings.features.restartFailed": "The server did not come back after the restart. Check the server logs or start it manually.",
  ...
  "settings.llm.section.format": "Tool Format",
  "settings.llm.section.burst": "Shell Burst Limiting",
  "settings.llm.section.toolOutput": "Tool Output Filtering",
  "settings.llm.section.compaction": "Context Compaction",
  "settings.llm.section.workflow": "Workflow",
  "settings.llm.row.format.title": "Tool format",
  "settings.llm.row.format.description": "Format for tool call arguments sent to the LLM",
  "settings.llm.row.format.option.toon": "TOON (compact)",
  "settings.llm.row.format.option.json": "JSON (standard)",
  "settings.llm.row.burstMaxBytesPerSecond.title": "Rate limit burst bytes/s",
  "settings.llm.row.burstMaxBytesPerSecond.description": "Max bytes per second before burst limiting triggers",
  "settings.llm.row.burstStrategy.title": "Burst strategy",
  "settings.llm.row.burstStrategy.description": "Strategy for handling burst rate limits",
  "settings.llm.row.burstAction.title": "Burst action",
  "settings.llm.row.burstAction.description": "Action to take when burst rate is exceeded",
  "settings.llm.row.burstAction.option.warn": "Warn",
  "settings.llm.row.maxToolOutputLines.title": "Max tool output lines",
  "settings.llm.row.maxToolOutputLines.description": "Maximum lines of tool output before truncation",
  "settings.llm.row.maxToolOutputBytes.title": "Max tool output bytes",
  "settings.llm.row.maxToolOutputBytes.description": "Maximum bytes of tool output before truncation",
  "settings.llm.row.maxToolOutput.title": "Max tool output size",
  "settings.llm.row.maxToolOutput.description": "Maximum tool output size in characters before truncation",
  "settings.llm.row.compactAuto.title": "Auto compaction",
  "settings.llm.row.compactAuto.description": "Enable automatic compaction when context is full",
  "settings.llm.row.compactPrune.title": "Prune tool outputs",
  "settings.llm.row.compactPrune.description": "Enable pruning of old tool outputs during compaction",
  "settings.llm.row.compactTailTurns.title": "Tail turns",
  "settings.llm.row.compactTailTurns.description": "Number of recent turns to keep verbatim during compaction",
  "settings.llm.row.parallelToolCalls.title": "Parallel tool calls",
  "settings.llm.row.parallelToolCalls.description": "Allow the LLM to call multiple tools concurrently",
