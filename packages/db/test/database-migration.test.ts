...
import { DatabaseMigration } from "@diveeoi/db/database/migration"
import { migrations } from "@diveeoi/db/database/migration.gen"
import sessionUsageMigration from "@diveeoi/db/database/migration/20260510033149_session_usage"
import normalizeStoragePathsMigration from "@diveeoi/db/database/migration/20260601010001_normalize_storage_paths"
import sessionMessageProjectionOrderMigration from "@diveeoi/db/database/migration/20260603040000_session_message_projection_order"
import eventSourcedSessionInputMigration from "@diveeoi/db/database/migration/20260604172448_event_sourced_session_input"
import contextEpochAgentMigration from "@diveeoi/db/database/migration/20260605042240_add_context_epoch_agent"
import simplifyIntegrationCredentialsMigration from "@diveeoi/db/database/migration/20260611192811_lush_chimera"
import { ProjectV2 } from "@diveeoi/db/project"
import { ProjectTable } from "@diveeoi/db/project/sql"
import { AbsolutePath } from "@diveeoi/db/schema"
import { SessionSchema } from "@diveeoi/db/session/schema"
import { SessionTable } from "@diveeoi/db/session/sql"
import sessionMetadataMigration from "@diveeoi/db/database/migration/20260511173437_session-metadata"
