...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@diveeoi/llm"
...
export class Service extends Context.Service<Service, Interface>()("@diveeoi/v2/ToolRegistry") {}
