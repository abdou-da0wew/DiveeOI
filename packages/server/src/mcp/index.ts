...
const disabledLayer = Layer.succeed(
  ...
  Service.of({
    ...
    startAuth: (mcpName) => Effect.fail(new NotFoundError({ name: mcpName })),
    authenticate: (mcpName) => Effect.fail(new NotFoundError({ name: mcpName })),
    finishAuth: (mcpName) => Effect.fail(new NotFoundError({ name: mcpName })),
    removeAuth: () => Effect.void,
    supportsOAuth: (mcpName) => Effect.fail(new NotFoundError({ name: mcpName })),
