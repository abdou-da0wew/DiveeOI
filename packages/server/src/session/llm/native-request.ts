import type { JsonSchema, LLMRequest, ProviderMetadata } from "@diveeoi/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@diveeoi/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @diveeoi/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
