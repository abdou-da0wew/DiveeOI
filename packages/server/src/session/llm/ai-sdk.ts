import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@diveeoi/llm"
...
// Move this extraction into @diveeoi/llm when Copilot is handled by the native runtime.
