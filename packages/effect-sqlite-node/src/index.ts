...
export const TypeId: TypeId = "~@diveeoi/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@diveeoi/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@diveeoi/effect-sqlite-node/NodeSqliteClient")
